...
import io.metamodel.attribut.value.RangeValue;
import io.metamodel.attribut.value.UniqueValue;
...
public class AttributeFactory {
	 ...
	 */
	public IAttribute createAttribute(String name, GSEnumDataType dataType, List<String> values,
	 ...
	 */
	public IAttribute createAttribute(String name, GSEnumDataType dataType, List<String> values,
			GSEnumAttributeType attributeType, IAttribute referentAttribute, Map<Set<String>, Set<String>> mapper) 
					throws GSIllegalRangedData {
	 ...
	 * @throws GSIllegalRangedData
	 */
	public IAttribute createAttribute(String name, GSEnumDataType dataType, List<String> inputValues, 
	...
	public IAttribute createAttribute(String name, GSEnumDataType dataType, List<String> inputValues, List<String> modelValues,
			GSEnumAttributeType attributeType, IAttribute referentAttribute, Map<Set<String>, Set<String>> mapper) throws GSIllegalRangedData {
		IAttribute att = null;
	...
	public IValue createValue(GSEnumAttributeType valueType, GSEnumDataType dataType, List<String> inputValues, 
			List<String> modelValues, IAttribute attribute) throws GSIllegalRangedData {
	...
	private Set<IValue> getValues(GSEnumAttributeType attributeType, GSEnumDataType dataType, List<String> inputValues, 
			List<String> modelValues, IAttribute attribute) throws GSIllegalRangedData{
	...
	private IValue getEmptyValue(GSEnumAttributeType attributeType, GSEnumDataType dataType, IAttribute attribute) {
		switch (attributeType) {
		case unique:
