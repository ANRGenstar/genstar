...
public abstract class AValue implements IValue {
	...
	public AValue(String inputStringValue, String mappedStringValue, GSEnumDataType dataType, IAttribute attribute){
	...
	public AValue(String inputStringValue, GSEnumDataType dataType, IAttribute attribute) {
