...
private static final String GS_CONFIG_ALIAS = "GosplConfiguration";
	...
	public GosplXmlSerializer() throws FileNotFoundException{
		...
		xs.alias(GS_METADATA_FILE_ALIAS, GosplMetaDataType.class);
		 ...
		 * Map Converter
		 */
		xs.registerConverter(new NamedMapConverter(xs.getMapper(), null, "Relative_path", Path.class, "Meta_data_type", GosplMetaDataType.class));
