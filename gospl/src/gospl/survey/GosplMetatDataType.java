 ...
 * <li> {@link GosplMetatDataType#LocalFrequencyTable}: proportion of category related to one referent category <p> e.g. age(22) = 49% / 51% of male / female
 * <li> {@link GosplMetatDataType#GlobalFrequencyTable}: proportion of a category of individual <p> e.g. age(22) = 12% of the population
 * </ul><p>
 * 
 * @author kevinchapuis
 *
