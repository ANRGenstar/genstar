...
public class TestINSEEDictionaryUtils {
	...
	public void testLoadFromURL1() {
		...
		Collection<APopulationAttribute> attributes = ReadINSEEDictionaryUtils.readFromWebsite("https://www.insee.fr/fr/statistiques/2863616?sommaire=2867837#dictionnaire");
		...
		Map<String,APopulationAttribute> name2att = attributes.stream().collect(Collectors.toMap(a->a.getAttributeName(), a->a));
		
		assertNotNull("expecting variable AGE4", name2att.get("AGE4"));
		assertNotNull("variable AGE4 should contain 00", name2att.get("AGE4").getValue("00"));
	...
	public void testLoadFromURL2() {
		...
		Collection<APopulationAttribute> attributes = ReadINSEEDictionaryUtils.readFromWebsite("https://www.insee.fr/fr/statistiques/2863607?sommaire=2867825#dictionnaire");
		...
		assertNotNull("variable AGEMEN7 should contain 00", name2att.get("AGEMEN7").getValue("00"));
	...
	public void testLoadFromDictionaryMODFile() {
		...
		Collection<APopulationAttribute> attributes = ReadINSEEDictionaryUtils.readDictionnaryFromMODFile("src/test/resources/MOD_INDREG_2014.txt");
